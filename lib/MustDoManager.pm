...
has config_file => (
  ...
  default => sub {
    ...
    return sprintf('/var/%s.yml', $package_string);
  },
);
...
MustDoManager - tiny application to manage
daily to-do list

=head1 SYNOPSIS

  my $taskmanager = MustDoManager->new();
...
in which the MustDoManager persists its to-do list data.
...
On initalization, a MustDoManager instance
...
An instance of C<< MustDoManager >> may
